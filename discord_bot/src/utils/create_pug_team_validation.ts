...
export async function validatePugTeams(
  ...
  // 🟡 1. Check for duplicates across both teams
  ...
  // 🟢 3. Check if both teams have at least 1 player (optional)
  if (team1Count === 0 || team2Count === 0) {
    console.warn("⚠️ One of the teams is empty!");
    await interaction.editReply({
      content: "⚠️ Both teams must have at least one player before continuing.",
    });
    return true;
  }
